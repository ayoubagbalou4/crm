...
const CalendarView = () => {
    ...
    const handleDayClick = (day) => {
        setSelectedSlot({
            ...
            time: moment().format('HH:mm') // Default to current time
        });
    ...
    const renderDayCell = (day) => {
        ...
        return (
            <div 
                ...
                className={`bg-white p-2 ${view === 'month' ? 'h-32' : 'h-32'} ${
            ...
            <div className="flex-1 overflow-auto p-4 bg-gray-50">
                        ...
                        <div className="flex rounded-md shadow-sm">
                            <button 
                                ...
                                className={`relative inline-flex items-center px-4 py-2 rounded-l-md border border-gray-300 text-sm font-medium ${
                                    view === 'day' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'
                                }`}
                            >
                                Day
                            </button>
                            <button 
                                ...
                                className={`-ml-px relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium ${
                                    view === 'week' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'
                                }`}
                            >
                                Week
                            </button>
                            <button 
                                ...
                                className={`-ml-px relative inline-flex items-center px-4 py-2 rounded-r-md border border-gray-300 text-sm font-medium ${
                                    view === 'month' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'
                                }`}
                            >
                                Month
                            </button>
                ...
                <div className="mt-8">
                    ...
                    <div className="mt-4 bg-white shadow overflow-hidden sm:rounded-md">
                        <ul className="divide-y divide-gray-200">
                            {bookings
                                .filter(b => moment(`${b.date}T${b.time}`).isAfter(moment()))
                                                ...
                                                <div className="mt-2 sm:flex sm:justify-between">
                                                    <div className="sm:flex">
                                                        <p className="flex items-center text-sm text-gray-500">
                                                            ...
                                                            {moment(booking.date).format('ddd, MMM D')}, {moment(booking.time, 'HH:mm').format('h:mm A')}
                                                        </p>
                                                    </div>
                ...
                {showModal && (
                    <BookingModal
                        ...
                        onCancelBooking={selectedBooking ? () => handleCancelBooking(selectedBooking._id) : null}
                    />
                )}
            </div>
        } />
