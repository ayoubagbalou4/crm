...
const { register, login, getUsers, logout , tally , loginGoogle , generateFromSubmit , updateProfile , updatePassword , updatePicture } = require("../controllers/authController");
